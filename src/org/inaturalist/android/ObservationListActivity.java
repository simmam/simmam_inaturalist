...
public class ObservationListActivity extends ListActivity {
    ...
    private class ObservationCursorAdapter extends SimpleCursorAdapter {
		...
		private Long strutjoinlong;
		private String strutjoin;
        ...
        public void getPhotoInfo() {
           ...
           ArrayList<Long> photoIds = new ArrayList<Long>();
            ...
            while (!c.isAfterLast()) {
                ...
                strutjoinlong = c.getLong(c.getColumnIndexOrThrow(Observation._ID));
                strutjoin += virgula + strutjoinlong.toString();
                virgula = ",";
                c.moveToNext();
            }
            ...
            Cursor opc = managedQuery(ObservationPhoto.CONTENT_URI, 
                    ...
                    "_observation_id IN ("+ strutjoin /*StringUtils.join(obsIds.toArray(),',')*/ +")", 
                    null, 
            ...
            while (!opc.isAfterLast()) {
                ...
                strutjoinlong = opc.getLong(opc.getColumnIndexOrThrow(ObservationPhoto._PHOTO_ID));
                strutjoin += virgula + strutjoinlong.toString();
                virgula = ",";                
                opc.moveToNext();
            }
            ...
            Cursor pc = managedQuery(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, 
                    ...
                    "_ID IN ("+ strutjoin /*StringUtils.join(photoIds, ',') */ + ")", 
                    null, 
                    null);
